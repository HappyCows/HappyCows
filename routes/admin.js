...
router.post('/common/degradation_update', auth_middleware, admin_middleware, admin_degradation_update);
...
router.post('/common/milk_test', auth_middleware, admin_middleware, admin_milking_test);
